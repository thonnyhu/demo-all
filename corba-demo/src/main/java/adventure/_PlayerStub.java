...
public class _PlayerStub extends org.omg.CORBA.portable.ObjectImpl implements Player
{
  ...
  public String user_name ()
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_user_name", true);
                $in = _invoke ($out);
  ...
  public String real_name ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_real_name", true);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
  ...
  public RoomID location ()
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                RoomID $result = adventure.RoomIDHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
