...
{
  private static String  _id = "IDL:adventure/Item:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.ORB.init ().create_interface_tc (ItemHelper.id (), "Item");
    }
    return __typeCode;
  }
  ...
  public static Item narrow (org.omg.CORBA.Object obj)
  {
    if (obj == null)
      return null;
    ...
    else
    {
      ...
      _ItemStub stub = new _ItemStub ();
      stub._set_delegate(delegate);
      return stub;
    }
  }

  public static Item unchecked_narrow (org.omg.CORBA.Object obj)
  {
    if (obj == null)
      return null;
    else if (obj instanceof Item)
