...
//            }
            roomServer.setCbRoomServer(tangx2);
            RoomServerImpl.MyRoom myRoom = roomServer.new MyRoom();
            Object object = poa.servant_to_reference(myRoom);
            String ioc = orb.object_to_string(object);
            System.out.println(ioc);
            Room myRoomRef = RoomHelper.narrow(object);
            roomServer.setIoc(ioc);
